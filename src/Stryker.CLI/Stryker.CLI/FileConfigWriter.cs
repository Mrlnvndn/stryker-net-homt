    ...
    private static FileBasedInputOuter CreateConfig(IStrykerInputs inputs)
    {
        return new FileBasedInputOuter
        {
            Input = new FileBasedInput
            {
                ...
                HOMTAccelerate = inputs.HOMTAccelerateInput.SuppliedInput ?? inputs.HOMTAccelerateInput.Default,
                HOMTValidate = inputs.HOMTValidateInput.SuppliedInput ?? inputs.HOMTValidateInput.Default,
